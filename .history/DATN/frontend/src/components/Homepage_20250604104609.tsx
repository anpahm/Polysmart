                  ...
                  <div className="p-4">
                    ...
                    <div className="space-y-2">
                      ...
                      {product.variants && product.variants.length > 0 && (() => {
                        ...
                        const total = product.variants.reduce((sum, v) => sum + (v.so_luong_hang || 0), 0);
                        ...
                        return (
                          <>
                            ...
                            <button className="w-full mt-1 py-1.5 rounded-md bg-blue-50 text-blue-600 font-bold text-[12px] hover:bg-blue-100 transition-all">
                              Mua ngay
                            </button>
                          </>
                        );
                    ...
                    {/* Variants */}
                    {/* Không hiển thị các variant bên dưới */}
                  </div>
                </Link>
              ))}
            </div>
