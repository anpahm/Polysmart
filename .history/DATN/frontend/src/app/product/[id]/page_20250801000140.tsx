  ...
  useEffect(() => {
    ...
    const fetchProductAndFlashSale = async () => {
      try {
        ...
        const flashSaleVariantOnPage = productData.variants.find(
          (v: ProductVariant) => flashSaleVariantsMap.has(v._id)
        );
        ...
        if (currentVariant && flashSaleVariantsMap.has(currentVariant._id)) {
          setFlashSalePrice(
            flashSaleVariantsMap.get(currentVariant._id) ?? null
          );
        } else {
        ...
        setFlashSaleVariants(
          activeFlashSales.flatMap((sale) => sale.flashSaleVariants)
        );
      } catch (error) {
...
<div className="w-full max-w-[1200px] flex flex-col gap-0 px-4 sm:px-8">
          {specs.map((spec, idx) => (
            <div
              key={spec.label}
            ...
            >
              <div className="w-full sm:w-[530px] min-w-[180px] font-semibold text-gray-700 text-[13px] flex items-start pt-1">
                {spec.label}:
              </div>
  ...
  return (
<div className="container mx-auto px-4 sm:px-6 md:px-10 lg:px-40 py-8">
      {/* Breadcrumbs */}
...
<div className="w-full lg:w-[590px]">
        ...
        <div className="flex-1">
          ...
          <div className="w-full bg-white border border-gray-200 rounded-xl p-5 mb-6 shadow-sm lg:w-[569px]">
            ...
            <div className="font-bold text-red-600 mb-1 text-[13px]">
              I. Ưu đãi thanh toán
            </div>
            <ul className="space-y-1 mb-2">
              ...
              <li className="flex items-start gap-2 text-[13px]">
                ...
                <a href="#" className="text-blue-500 underline"></a>
              </li>
            </ul>
            <div className="font-bold text-red-600 mb-1 text-[13px]">
              II. Ưu đãi mua kèm
            ...
            <div className="font-bold text-red-500 mb-1 text-[13px]">
              III. Ưu đãi khác
            </div>
            <ul className="space-y-1 mb-2">
              <li className="flex items-start gap-2 text-[13px]">
  ...
  <div className="mt-12 border-t pt-8">
    ...
    <div className="flex flex-col lg:flex-row gap-6">
      ...
      <div className="relative w-full overflow-hidden">
        {/* Nút scroll trái */}
        <button
          className="hidden md:flex absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white rounded-full p-1 shadow hover:bg-gray-100"
        ...
        {/* Nút scroll phải */}
        <button
          className="hidden md:flex absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white rounded-full p-1 shadow hover:bg-gray-100"
      ...
      <div className="flex flex-col items-center mt-6 lg:mt-0 lg:ml-8 w-full">
        ...
        <button
          ...
          onClick={handleBuyAll} // giữ nguyên như cũ
        >
