...
<div className="w-full lg:w-[590px]">
        ...
        <div className="flex-1">
          ...
          {/* Ưu đãi*/}
          <div className="bg-white border border-gray-200 rounded-xl p-5 mb-6 shadow-sm lg:w-[569px]">
            ...
            >
              ...
              >
                {accessories.map((acc) => (
                  <div
                    key={acc._id}
                    className="min-w-[180px] max-w-[180px] bg-white rounded-xl shadow p-4 flex flex-col items-center border hover:border-blue-500 transition relative"
                  >
              ...
              .map((sp) => {
                ...
                return (
                  <Link
                    key={sp._id}
                    href={`/product/${sp._id}`}
                    className="bg-white rounded-xl shadow p-4 flex flex-col w-[280px] h-[370px] relative flex-shrink-0 hover:shadow-lg transition"
                  >
                    {/* Badge giảm giá */}
                    {discount > 0 && (
