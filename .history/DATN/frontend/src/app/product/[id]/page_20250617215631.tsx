            ...
            <div className="relative" style={{ width: 600, overflow: 'hidden' }}>
              ...
              <div
               ...
               style={{
                ...
                {accessories.map((acc) => (
                  <div key={acc._id} className="min-w-[180px] max-w-[220px] bg-white rounded-xl shadow p-4 flex flex-col items-center border hover:border-blue-500 transition relative">
