...
export default function ProfilePage() {
  ...
  const ORDER_TABS = [
    { key: "all", label: "Tất cả", count: orderTabCounts.all },
    {
      key: "confirming",
      label: "Chờ xác nhận",
      count: orderTabCounts.confirming,
    },
                    ...
                    <div>
                      <h3 className="font-bold text-gray-800 text-base">
                        ...
                        {isBehavior
                          ...
                          : ""}
                        {phan_tram === 0 && giam_toi_da === 0 && !isBehavior
                          ? mo_ta
                          : ""}
                      </h3>
    ...
    if (activeTab === "system") {
      return (
        <div>
          ...
          <p>
            Nội dung hệ thống, thông tin về các chức năng và cập nhật của hệ
            thống.
          </p>
        </div>
      );
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen bg-gray-100">
      ...
      {/* Sidebar */}
      <aside
        className={`bg-white shadow-md p-4 lg:p-6 w-full lg:w-64 transition-all duration-300 ${
          ...
          >
            ...
            >
              <path
                ...
                strokeLinejoin="round"
                strokeWidth="2"
                d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.828 0L6.343 16.657m10.607-2.121a8.001 8.001 0 00-11.314 0m11.314 0l.001.001h-.001zm-11.314 0L3.414 14.5a1.998 1.998 0 01-2.828 0L.343 12.343"
              ></path>
            </svg>
            Địa chỉ nhận hàng
          </button>
