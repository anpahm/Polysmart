      ...
      <section className="py-0 pt-10">
        <div className="container mx-auto px-40">
          <div className="bg-gradient-to-r from-red-600 to-pink-500 rounded-2xl p-8 shadow-xl overflow-hidden relative">
            ...
            <button
              className="swiper-button-prev absolute left-10 top-1/2 -translate-y-1/2 bg-white/80 rounded-full p-5 shadow hover:bg-blue-100 z-10">
              <svg width="10" height="10" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="text-blue-600">
                <path d="M15 19l-7-7 7-7" stroke="#484848" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </button>
            <button
