      ...
      {selectedVariant?.so_luong_hang !== 0 && (
        <div className="mt-12 border-t pt-8">
          ...
          <div className="flex items-stretch gap-6">
            {/* Sản phẩm chính */}
            <div className="flex flex-col items-center w-[200px] bg-white rounded-xl shadow p-4">
            ...
            <div className="relative" style={{ width: 600, overflow: 'hidden' }}>
              ...
              <div
               ...
               style={{
                ...
                {accessories.map((acc) => (
                  <div key={acc._id} className="className="min-w-[180px] max-w-[180px] ..."
 bg-white rounded-xl shadow p-4 flex flex-col items-center border hover:border-blue-500 transition relative">
