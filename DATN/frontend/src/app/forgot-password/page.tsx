  ...
  return (
    <div className="forgot-password-container min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-200/60 via-white/60 to-blue-100/80 py-8 px-2">
      <div className="forgot-password-card w-full max-w-md rounded-3xl shadow-2xl p-8 border border-blue-100 backdrop-blur-md bg-white/60 relative">
        ...
        <form onSubmit={handleSubmit} className="forgot-password-form space-y-5">
          <input
            type="email"
            className="forgot-password-input w-full border border-blue-200 rounded-full px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400 transition text-base bg-white/80 placeholder-gray-400"
        ...
        {message && (
          <>
            <div className="forgot-password-message mt-6 text-green-600 text-center font-semibold">{message}</div>
