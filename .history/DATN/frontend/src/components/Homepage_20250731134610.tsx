        ...
        <div className="bg-white rounded-2xl mt-10 p-4 sm:p-6 shadow-xl w-full">
          ...
          <div className="relative group">
            <Swiper
              ...
              loop={true}
              breakpoints={{
                320: { slidesPerView: 1, slidesPerGroup: 1, spaceBetween: 10 },     // Mobile nhỏ
                480: { slidesPerView: 2, slidesPerGroup: 2, spaceBetween: 15 },     // Mobile lớn
                640: { slidesPerView: 3, slidesPerGroup: 3, spaceBetween: 15 },     // Tablet dọc
                768: { slidesPerView: 3, slidesPerGroup: 3, spaceBetween: 20 },     // Tablet ngang
                1024: { slidesPerView: 4, slidesPerGroup: 4, spaceBetween: 20 },    // Desktop
              }}
