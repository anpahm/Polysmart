...
{showMobileFilter && (
  <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-end lg:hidden">
    <div className="w-4/5 sm:w-2/3 h-full bg-white p-4 overflow-y-auto relative shadow-lg">
      ...
      <h3 className="text-xl font-bold mb-4 mt-2">Bộ lọc</h3>

      {/* Dán lại toàn bộ phần JSX của bộ lọc vào đây (bên trong div này) */}
      {/* 👉 Bạn có thể copy từ phần bên trong div className="hidden lg:block ..." */}
    </div>
  </div>
)}
